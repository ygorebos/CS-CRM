...
| `escopos-do-corretor.architecture.json` | **o que o corretor liga, carrega e remove** (spec 002, F2/F3/F4) — 17 peças, 20 arestas; as duas metades de FR-008, e por que a remoção **não pode** ser um `delete` |
